...
public class StorageUtils {
    public static final Comparator<StorageItem> DEFAULT_1;
    public static final Comparator<StorageItem> DEFAULT_2;
    public static final Comparator<StorageItem> DEFAULT_3;
