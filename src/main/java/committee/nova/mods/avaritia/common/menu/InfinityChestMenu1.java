...
// * @Description:
// */
//public class InfinityChestMenu1 extends BaseTileMenu<InfinityChestTile> {
...
//
//    public InfinityChestMenu1(int id, Inventory playerInventory, FriendlyByteBuf extraData) {
//        this(id, playerInventory, extraData.readBlockPos(), InfinityChestContainer.dummy(36), new SimpleContainerData(1));
//    }
//
//    public InfinityChestMenu1(int id, Inventory playerInventory, BlockPos pos, InfinityChestContainer chestInventory, final ContainerData chestData) {
...
//
//                public int get() {
//                    return InfinityChestMenu1.this.itemCounts.get(finalI);
//                }
//
//                public void set(int value) {
//                    InfinityChestMenu1.this.itemCounts.set(finalI, value);
//                }
//
