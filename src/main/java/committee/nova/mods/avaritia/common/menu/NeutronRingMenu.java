 ...
 * @Description:
 */
public class NeutronRingMenu extends BaseMenu implements IChangePage {
    ...
    public NeutronRingMenu(int id, Inventory playerInventory, int slot, OffsetContainer container) {
        ...
        for(int i2 = 0; i2 < this.countData.getCount(); ++i2) {
            ...
            this.addDataSlot(new DataSlot() {
                ...
                @Override public int get() {
                    return NeutronRingMenu.this.countData.get(finalI);
                }

                @Override public void set(int value) {
                    NeutronRingMenu.this.countData.set(finalI, value);
                }
                ...
                public boolean checkAndClearUpdateFlag() {
                    if (super.checkAndClearUpdateFlag()) {
                        ...
                        int page = NeutronRingMenu.this.storageWrapper.getPage();
